...
exports.loadTasks = async (req, res) => {
  ...
  try {
    ...
    existingPlans.forEach((plan) => {
      Object.assign(planObj, { [plan.plan_mvp_name]: plan.plan_colour });
    });
    ...
    res
      .status(500)
      .send(`An error occured while loading tasks: ${error.message}`);
  }
};
...
exports.loadTask = async (req, res) => {
  ...
  try {
    ...
    res
      .status(500)
      .send(`An error occured while loading task: ${error.message}`);
  }
};
