...
router.post("/gettaskbystate", restAPI.gettaskbystate);
router.post("/createtask", restAPI.createTask);
router.patch("/promotetask2done", restAPI.promotetask2done);
...
router.use((req, res) => res.status(404).send("Error in fetch method"));
